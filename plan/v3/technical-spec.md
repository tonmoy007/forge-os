...
- **Reference Implementations**:
  ...
  - `OpenCLawAdapter`: Bridges Forge OS to OpenClaw Gateway via REST.
  - `LocalLLMAdapter`: Uses a local LLaMA/ChatGLM process with a lightweight tool‑calling wrapper.
